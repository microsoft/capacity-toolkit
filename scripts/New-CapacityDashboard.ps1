...
<footer>Generated by the Azure Capacity &amp; Enablement Toolkit &middot; read-only analysis (Reader access) &middot; quota does not guarantee capacity until deployed.</footer>
<script>$js</script>
</body></html>
"@
